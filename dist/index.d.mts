...
declare const ChartLegendContent: React$1.ForwardRefExoticComponent<Omit<React$1.ClassAttributes<HTMLDivElement> & React$1.HTMLAttributes<HTMLDivElement> & Pick<RechartsPrimitive.LegendProps, "verticalAlign"> & {
    hideIcon?: boolean;
    nameKey?: string;
    payload?: any[];
}, "ref"> & React$1.RefAttributes<HTMLDivElement>>;
...
declare const GO_APPS: AppInfo[];
declare function AppSwitcher({ currentApp, apps, onNavigate, placement, }: AppSwitcherProps): react_jsx_runtime.JSX.Element;
declare function AppSidebar({ currentApp, apps, navItems, logo, onNavigate, ...props }: AppSidebarProps): react_jsx_runtime.JSX.Element;
...
declare function UserMenu({ displayName, email, avatarUrl, items, signOut, placement, triggerLabel, }: UserMenuProps): react_jsx_runtime.JSX.Element;
