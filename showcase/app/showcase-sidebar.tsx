...
import { LayoutDashboard, Palette, Package, FileText } from "lucide-react";
...
const APPS = [
  ...
  {
    name: "PhysicalGo",
    url: "https://physical-go.vercel.app",
    color: "#3B82F6",
  },
];
...
export function ShowcaseSidebar() {
  ...
  return (
    <AppSidebar currentApp="Go Design System" apps={APPS} navItems={navItems} />
  );
}
