...
import {
  SettingsPage, SettingsGroup, SettingsItem,
        ...
        <div className="flex flex-col gap-6">
          <SettingsGroup title="基本情報">
            ...
            <SettingsItem
              ...
              control={<Input defaultValue="yamada@example.com" type="email" className="w-56" />}
            />
          </SettingsGroup>
        ...
        <div className="flex flex-col gap-6">
          <SettingsGroup title="アカウントセキュリティ">
            ...
            <SettingsItem
              ...
              control={<Button variant="outline" size="sm">履歴を確認</Button>}
            />
          </SettingsGroup>
          <SettingsGroup title="危険ゾーン">
            <SettingsItem
              ...
              control={<Button variant="destructive" size="sm">アカウントを削除</Button>}
            />
          </SettingsGroup>
        </div>
      ),
    ...
    <div className="flex flex-col gap-4">
      <div className="rounded-md border border-primary/30 bg-primary/5 px-4 py-2">
        <p className="text-xs text-primary font-medium">
          テンプレートプレビュー — <code>SettingsPage</code> コンポーネントのダミーデータ表示
        </p>
      </div>
